...
echo "Starting release for timber-loggly-${version} ..."
...
#hub release edit -m '' v_${version} -a build/timber-loggly-${version}.jar
echo TODO: attach aar/jar to release at:
echo https://github.com/tony19/timber-loggly/releases/tag/timber-loggly-${version}
